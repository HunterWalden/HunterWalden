...
- [A temporary storage system that exports unsaved object changes to a file that can be recovered if the program crashes/closes unexpectedly](/mapmaker/tempstorage.html)
...
- [Map objects moved to their own individual classes](/mapmaker/mapobjects.html)
